<h1 align="center">🛡️ Blue Team Roadmap</h1>

<p align="center">
  <strong>The most comprehensive, step-by-step roadmap for breaking into defensive cybersecurity.</strong><br>
...
<p align="center">
  <a href="https://github.com/keraattin/Blue-Team-Roadmap/stargazers"><img src="https://img.shields.io/github/stars/keraattin/Blue-Team-Roadmap?style=social" alt="Stars"/></a>
  <a href="https://github.com/keraattin/Blue-Team-Roadmap/fork"><img src="https://img.shields.io/github/forks/keraattin/Blue-Team-Roadmap?style=social" alt="Forks"/></a>
</p>
...
- 📚 **Structured as a learning path**, not just a random list of tools
- 🔢 **Ordered by learning sequence**, each phase builds on the previous one
- 🆓 **Prioritizes free resources**, you can follow this entire roadmap without spending a dollar on courses
...
- 🔄 **Career switchers** coming from other fields
- 🎓 **Students** studying cybersecurity or related fields
- 💼 **IT professionals** wanting to transition into security
- 🔵 **Junior SOC analysts** looking to level up their skills
...
> **Timeline:** Weeks 1-4 · **Effort:** 2-3 hours/day
...
| Resource | Type | Link |
|----------|------|------|
| Professor Messer, Network+ N10-009 | Video (87 episodes) | [YouTube](https://www.youtube.com/playlist?list=PLG49S3nxzAnlCJiCrOYuRYb6cne864a7G) |
| TryHackMe, Pre-Security Path | Interactive Labs | [tryhackme.com](https://tryhackme.com/path/outline/presecurity) |
| Cisco Networking Academy, Intro to Networks | Course | [netacad.com](https://www.netacad.com/) |
| Practical Networking | YouTube Channel | [YouTube](https://www.youtube.com/@PracticalNetworking) |
| Subnetting Practice | Drill Site | [subnettingpractice.com](https://subnettingpractice.com/) |
| Sunny Classroom, Networking Tutorials | YouTube | [YouTube](https://www.youtube.com/@SunnyClassroom) |
| Jeremy's IT Lab, CCNA Course | YouTube (Free) | [YouTube](https://www.youtube.com/@JesremysITLab) |
...
> **Timeline:** Weeks 3-6 · **Effort:** 2-3 hours/day
...
- Multiple **4625** → single **4624** = successful brute force
...
- Install with [SwiftOnSecurity's Sysmon config](https://github.com/SwiftOnSecurity/sysmon-config) for a well-tuned baseline
- Alternative: [Olaf Hartong's Sysmon Modular config](https://github.com/olafhartong/sysmon-modular)
...
| Resource | Type | Link |
|----------|------|------|
| TryHackMe, Windows Fundamentals 1, 2, 3 | Interactive Labs | [tryhackme.com](https://tryhackme.com/room/windowsfundamentals1xbx) |
| TryHackMe, Active Directory Basics | Lab | [tryhackme.com](https://tryhackme.com/room/winadbasics) |
| TryHackMe, Windows Event Logs | Lab | [tryhackme.com](https://tryhackme.com/room/windowseventlogs) |
| TryHackMe, Sysmon | Lab | [tryhackme.com](https://tryhackme.com/room/sysmon) |
| Microsoft Learn, Windows Server | Free Course | [learn.microsoft.com](https://learn.microsoft.com/en-us/training/paths/windows-server-deployment-configuration-administration/) |
| 13Cubed, Windows Forensics | YouTube | [YouTube](https://www.youtube.com/@13Cubed) |
| SANS Windows Forensic Analysis Poster | Cheat Sheet (Free) | [sans.org](https://www.sans.org/posters/) |
...
> **Timeline:** Weeks 4-7 · **Effort:** 2 hours/day
...
| Resource | Type | Link |
|----------|------|------|
| OverTheWire, Bandit | Wargame (34 levels) | [overthewire.org](https://overthewire.org/wargames/bandit/) |
| TryHackMe, Linux Fundamentals (1, 2, 3) | Interactive Labs | [tryhackme.com](https://tryhackme.com/room/linuxfundamentalspart1) |
| LetsDefend, Linux for Blue Team | Course (CISA recognized) | [letsdefend.io](https://app.letsdefend.io/training/lessons/linux-for-blue-team) |
| Linux Journey | Interactive Tutorial | [linuxjourney.com](https://linuxjourney.com/) |
| Explainshell | Command Explainer | [explainshell.com](https://explainshell.com/) |
| The Linux Command Line (Book) | Free PDF | [linuxcommand.org](https://linuxcommand.org/tlcl.php) |
...
> **Timeline:** Weeks 5-8 · **Effort:** 2-3 hours/day
...
```python
# File handling — read and parse log files
...
# Requests — API calls (VirusTotal, AbuseIPDB, Shodan)
import requests
...
# Hashlib — hash files for IOC checking
import hashlib
...
Practice at: [regex101.com](https://regex101.com/), paste a log sample and build patterns.

### 🆓 Free Learning Resources

| Resource | Type | Link |
|----------|------|------|
| Automate the Boring Stuff with Python | Free Book | [automatetheboringstuff.com](https://automatetheboringstuff.com/) |
| TryHackMe, Python Basics | Lab | [tryhackme.com](https://tryhackme.com/room/pythonbasics) |
| Codecademy, Learn Python 3 | Interactive Course | [codecademy.com](https://www.codecademy.com/learn/learn-python-3) |
| Python for Cybersecurity Specialization | Coursera (Audit free) | [coursera.org](https://www.coursera.org/specializations/pythonforcybersecurity) |
| Regex101 | Practice Tool | [regex101.com](https://regex101.com/) |
| SQLBolt | Interactive SQL Tutorial | [sqlbolt.com](https://sqlbolt.com/) |
| Bash Scripting Tutorial | Guide | [linuxconfig.org](https://linuxconfig.org/bash-scripting-tutorial) |
...
The industry standard for categorizing adversary behavior. Contains **14 tactics** with 200+ techniques.
...
**Start exploring:** [attack.mitre.org](https://attack.mitre.org/)

#### 5.4 Security Frameworks

| Framework | Purpose | Key Points | Link |
|-----------|---------|-----------|------|
| **NIST CSF 2.0** | Big-picture security strategy | 5 functions: Identify, Protect, Detect, Respond, Recover | [nist.gov](https://www.nist.gov/cyberframework) |
| **NIST SP 800-61** | Incident Response | 4 phases: Preparation, Detection & Analysis, Containment/Eradication/Recovery, Post-Incident Activity | [nist.gov](https://csrc.nist.gov/pubs/sp/800/61/r2/final) |
| **CIS Controls v8.1** | Prioritized security actions | 18 controls ordered by priority, organized into 3 implementation groups | [cisecurity.org](https://www.cisecurity.org/controls) |
| **ISO 27001** | Information Security Management System | International standard for security programs, important for GRC roles | [iso.org](https://www.iso.org/isoiec-27001-information-security.html) |
| **NIST SP 800-53** | Security & Privacy Controls | Comprehensive catalog of security controls for federal systems | [nist.gov](https://csrc.nist.gov/pubs/sp/800/53/r5/upd1/final) |
...
| Resource | Type | Link |
|----------|------|------|
| TryHackMe, SOC Level 1 Path | Learning Path | [tryhackme.com](https://tryhackme.com/path/outline/soclevel1) |
| Professor Messer, Security+ SY0-701 | Video (177 episodes) | [YouTube](https://www.youtube.com/playlist?list=PLG49S3nxzAnl4QDVqK-hOnoqcSKEIDDuv) |
| MITRE ATT&CK | Framework | [attack.mitre.org](https://attack.mitre.org/) |
| NIST Cybersecurity Framework | Framework | [nist.gov](https://www.nist.gov/cyberframework) |
| CIS Controls | Framework | [cisecurity.org](https://www.cisecurity.org/controls) |
| Cybrary, SOC Analyst Path | Free Course | [cybrary.it](https://www.cybrary.it/) |
...
|------|----------------|---------------|-------------|----------|
| **Splunk** | Market leader, 78% of job postings | SPL | Free tier (500MB/day) | [splunk.com](https://www.splunk.com/en_us/download.html) |
| **Microsoft Sentinel** | Fastest growing, best AI integration | KQL | Free for M365 data | [Microsoft Learn](https://learn.microsoft.com/en-us/training/paths/sc-200-mitigate-threats-using-microsoft-365-defender/) |
| **Elastic SIEM (ELK)** | Open source, highly flexible | Lucene / KQL | 100% free | [elastic.co](https://www.elastic.co/security) |
| **Wazuh** | Open source, unlimited | Own syntax | 100% free | [wazuh.com](https://wazuh.com/) |
| **IBM QRadar CE** | Enterprise, regulated industries | AQL | Community Edition | [ibm.com](https://www.ibm.com/qradar) |
...
|------|---------|------|------|
| **Wireshark** | Packet capture and deep protocol analysis | Packet Analyzer | [wireshark.org](https://www.wireshark.org/) |
| **Suricata** | High-performance IDS/IPS, multi-threaded | IDS/IPS | [suricata.io](https://suricata.io/) |
| **Snort** | Signature-based IDS/IPS (Cisco) | IDS/IPS | [snort.org](https://www.snort.org/) |
| **Zeek (Bro)** | Network metadata extraction, rich logs | Network Monitor | [zeek.org](https://zeek.org/) |
| **NetworkMiner** | Network forensic analysis, PCAP parser | NFAT | [netresec.com](https://www.netresec.com/) |
| **tcpdump** | Command-line packet capture | CLI Tool | Built into Linux |
| **Arkime (Moloch)** | Large scale PCAP capture and search | PCAP Search | [arkime.com](https://arkime.com/) |

### 6.4 Forensics & Incident Response

| Tool | Purpose | Link |
|------|---------|------|
| **Volatility 3** | Memory forensics (RAM analysis) | [github.com/volatilityfoundation](https://github.com/volatilityfoundation/volatility3) |
...
| **Velociraptor** | Endpoint investigation at scale | [github.com/Velocidex](https://github.com/Velocidex/velociraptor) |
| **Eric Zimmerman's Tools** | Windows artifact parsing (MFT, ShellBags, etc.) | [ericzimmerman.github.io](https://ericzimmerman.github.io/) |
| **Chainsaw** | Windows event log hunting | [github.com/WithSecureLabs](https://github.com/WithSecureLabs/chainsaw) |

### 6.5 Detection & Threat Intelligence

| Tool/Standard | Purpose | Link |
|-------------|---------|------|
| **SIGMA Rules** | Vendor-agnostic detection rules (3,000+) | [github.com/SigmaHQ](https://github.com/SigmaHQ/sigma) |
| **YARA Rules** | Malware pattern matching | [github.com/VirusTotal/yara](https://github.com/VirusTotal/yara) |
...
| **OpenCTI** | Cyber threat intelligence platform | [opencti.io](https://www.opencti.io/) |
| **VirusTotal** | File/URL/IP analysis | [virustotal.com](https://www.virustotal.com/) |
| **AbuseIPDB** | IP reputation database | [abuseipdb.com](https://www.abuseipdb.com/) |
| **URLScan.io** | URL analysis and scanning | [urlscan.io](https://urlscan.io/) |
| **ANY.RUN** | Interactive malware sandbox | [any.run](https://any.run/) |
| **Hybrid Analysis** | Free malware analysis | [hybrid-analysis.com](https://www.hybrid-analysis.com/) |
...
| **Shuffle** | Open-source SOAR | [github.com/Shuffle](https://github.com/Shuffle/Shuffle) |
...
|------|------|--------|-----------|-----------|---------------------|
| **CompTIA Security+ (SY0-701)** | $425 | 90 MCQ + PBQ, 750/900 pass | 4-8 weeks | In nearly every job posting. Globally recognized. Required for U.S. DoD roles. | [Professor Messer](https://www.youtube.com/playlist?list=PLG49S3nxzAnl4QDVqK-hOnoqcSKEIDDuv) (177 free videos) |
| **BTL1 (Blue Team Level 1)** | ~$495 | 24-hour hands-on lab exam | 8-12 weeks | Proves practical ability. Called "the OSCP of Blue Team." Training + exam included. | [Security Blue Team BTJA](https://www.securityblue.team/courses/blue-team-junior-analyst-pathway-bundle) (free pathway) |
| **Microsoft SC-200** | $165 | MCQ + case studies | 4-6 weeks | Validates Sentinel/KQL skills. Free training. Free annual renewal. Best value cert. | [Microsoft Learn](https://learn.microsoft.com/en-us/credentials/certifications/security-operations-analyst/) (100% free) |
...
> 💡 **Tip:** GIAC certifications are extremely valuable but expensive. Get your employer to sponsor them after landing your first role.
...
|---|----------|---------------|------|----------|------|
| 1 | **TryHackMe** | Browser-based labs, SOC L1/L2 paths, 40+ defensive rooms | Free + $14/mo | Absolute beginners | [tryhackme.com](https://tryhackme.com/) |
| 2 | **Blue Team Labs Online** | 254+ investigations, free BTJA pathway (6-7 hrs) | Free tier | Quick Blue Team intro | [blueteamlabs.online](https://blueteamlabs.online/) |
| 3 | **LetsDefend** | Simulated SOC dashboard, alert queue, Elastic SIEM, 3000+ logs | Free tier | SOC workflow practice | [letsdefend.io](https://letsdefend.io/) |
| 4 | **CyberDefenders** | Blue Team CTF challenges, 15+ categories, weekly new labs | Free tier | Intermediate challenges | [cyberdefenders.org](https://cyberdefenders.org/) |
| 5 | **Hack The Box** | 100+ Sherlock defensive labs, Academy SOC path | $8/mo student | Advanced practice, CDSA path | [hackthebox.com](https://www.hackthebox.com/) |
...
|----------|-----------|------|
| **Splunk BOTS** | Free Boss of the SOC CTF for SPL practice | [splunk.com](https://bots.splunk.com/) |
| **KC7** | Free game-based KQL training | [kc7.dev](https://kc7.dev/) |
| **OpenSOC** | Free Blue Team competitions at DEF CON/BSides | [opensoc.io](https://opensoc.io/) |
| **Malware Traffic Analysis** | PCAP exercises with real malware traffic | [malware-traffic-analysis.net](https://www.malware-traffic-analysis.net/) |
| **SANS Holiday Hack Challenge** | Annual free security challenge | [holidayhackchallenge.com](https://www.holidayhackchallenge.com/) |
| **RangeForce** | Enterprise security simulations | [rangeforce.com](https://www.rangeforce.com/) |
...
2. **Adversary Emulation with Atomic Red Team**
   - Install [Atomic Red Team](https://github.com/redcanaryco/atomic-red-team) on a test machine
   ...
   - Document: technique tested → expected alert → actual result → rule created

3. **Phishing Analysis Pipeline**
   - Build a workflow: receive phishing email → analyze headers → decode URLs → sandbox attachments → extract IOCs
   - Tools: [PhishTool](https://www.phishtool.com/), [URLScan.io](https://urlscan.io/), [ANY.RUN](https://any.run/)
...
6. **Open-Source Detection Rule Contributions**
   ...
   - Contribute to [SigmaHQ/sigma](https://github.com/SigmaHQ/sigma)
...
> 💡 **Blog about everything you build.** Multiple sources confirm that Medium writeups of TryHackMe rooms and CTF challenges have directly led to interview callbacks for beginners.
...
|--------|---------------|------|
| **LinkedIn** | Largest job board, recruiter messaging | [linkedin.com/jobs](https://www.linkedin.com/jobs/) |
| **Indeed** | Broad job aggregator | [indeed.com](https://www.indeed.com/) |
| **CyberSeek** | Maps cybersecurity positions worldwide | [cyberseek.org](https://www.cyberseek.org/) |
| **Hack The Box Jobs** | Built for cybersecurity candidates | [hackthebox.com/jobs](https://www.hackthebox.com/jobs) |
| **SANS CyberTalent** | Hiring events and apprenticeships | [sans.org/cybertalent](https://www.sans.org/cybertalent/) |
...
| GitHub, SOC-Interview-Questions | [github.com/LetsDefend](https://github.com/LetsDefend/SOC-Interview-Questions) |
...
```
IT Support → SOC Analyst T1 → T2 → T3/Threat Hunter → Senior Lead → Security Engineer → Architect → CISO
```
...
- **🤖 AI in the SOC:** 55% of security teams deploy AI copilots. Investigations complete 45-61% faster. Learn to work WITH AI, not against it.
...
- **🔐 Zero Trust:** U.S. DoD allocated $977M for zero trust. NIST released SP 1800-35. 63% of organizations implementing.
- **🔍 Detection Engineering:** Hottest Blue Team specialty ($119K-$215K). Detection-as-code, SIGMA rules, CI/CD pipelines.
- **🤖 SOAR & Automation:** 50+ agentic SOC vendors. AI handling 60% of SOC workloads within 3 years.
...
| John Hammond | CTFs, DFIR, malware analysis | [YouTube](https://www.youtube.com/@_JohnHammond) |
| 13Cubed | Windows forensics, memory analysis | [YouTube](https://www.youtube.com/@13Cubed) |
| Simply Cyber | Daily news and career guidance | [YouTube](https://www.youtube.com/@SimplyCyber) |
| Day Cyberwox | Cloud security and home labs | [YouTube](https://www.youtube.com/@DayCyberwox) |
...
| Blog | Focus | Link |
|------|-------|------|
| The DFIR Report | Real intrusion analyses with ATT&CK | [thedfirreport.com](https://thedfirreport.com/) |
| Red Canary Blog | Threat detection report, detection engineering | [redcanary.com/blog](https://redcanary.com/blog/) |
| SANS Internet Storm Center | Daily security diaries | [isc.sans.edu](https://isc.sans.edu/) |
| Krebs on Security | Investigative cybersecurity journalism | [krebsonsecurity.com](https://krebsonsecurity.com/) |
| Elastic Security Labs | Threat research and detection rules | [elastic.co/security-labs](https://www.elastic.co/security-labs) |

### Podcasts
| Podcast | Focus | Link |
|---------|-------|------|
| Darknet Diaries | True cybercrime stories | [darknetdiaries.com](https://darknetdiaries.com/) |
| SANS Blueprint | SOC operations and Blue Team leadership | [sans.org](https://www.sans.org/podcasts/blueprint/) |
| CyberWire Daily | Concise 15-min daily news | [thecyberwire.com](https://thecyberwire.com/podcasts/daily-podcast) |
| Defensive Security Podcast | Weekly breach reviews with defensive lessons | [defensivesecurity.org](https://defensivesecurity.org/) |
| Microsoft Threat Intelligence | APT insights from Microsoft researchers | [Microsoft](https://thecyberwire.com/podcasts/microsoft-threat-intelligence) |

### GitHub Repositories
| Repo | Description | Link |
|------|------------|------|
| SigmaHQ/sigma | 3,000+ vendor-agnostic detection rules | [github.com](https://github.com/SigmaHQ/sigma) |
| sbousseaden/EVTX-ATTACK-SAMPLES | Windows event log samples mapped to ATT&CK | [github.com](https://github.com/sbousseaden/EVTX-ATTACK-SAMPLES) |
| fabacab/awesome-cybersecurity-blueteam | Curated Blue Team tool list | [github.com](https://github.com/fabacab/awesome-cybersecurity-blueteam) |
| InQuest/awesome-yara | YARA rules collection | [github.com](https://github.com/InQuest/awesome-yara) |
| aboutsecurity/blueteam_homelabs | Home lab build resources | [github.com](https://github.com/aboutsecurity/blueteam_homelabs) |
| A-poc/BlueTeam-Tools | 65+ Blue Team tools list | [github.com](https://github.com/A-poc/BlueTeam-Tools) |
| SwiftOnSecurity/sysmon-config | Sysmon configuration template | [github.com](https://github.com/SwiftOnSecurity/sysmon-config) |
| redcanaryco/atomic-red-team | Adversary emulation for detection testing | [github.com](https://github.com/redcanaryco/atomic-red-team) |
| LetsDefend/SOC-Interview-Questions | Interview preparation | [github.com](https://github.com/LetsDefend/SOC-Interview-Questions) |

### Communities
| Community | Platform | Link |
|-----------|----------|------|
| Blue Team Village | Discord | [blueteamvillage.org](https://blueteamvillage.org/) |
| Security Blue Team | Discord (21K+ members) | [discord.gg/securityblueteam](https://discord.com/invite/bB7UWgy) |
| Black Hills InfoSec | Discord | [discord.gg/bhis](https://discord.gg/bhis) |
| r/blueteamsec | Reddit | [reddit.com/r/blueteamsec](https://www.reddit.com/r/blueteamsec/) |
| r/cybersecurity | Reddit | [reddit.com/r/cybersecurity](https://www.reddit.com/r/cybersecurity/) |
| r/netsec | Reddit | [reddit.com/r/netsec](https://www.reddit.com/r/netsec/) |
...
<p align="center">
  <strong>Made by <a href="https://github.com/keraattin">Kerem</a></strong><br>
  <sub>If this roadmap helped you, give it a ⭐ and share it with someone who needs it!</sub>
</p>

<p align="center">
  <a href="https://www.instagram.com/kerem.tech"><img src="https://img.shields.io/badge/Follow-@kerem.tech-E4405F?style=for-the-badge&logo=instagram&logoColor=white" alt="Instagram"/></a>
  <a href="https://github.com/keraattin"><img src="https://img.shields.io/badge/Follow-@keraattin-181717?style=for-the-badge&logo=github&logoColor=white" alt="GitHub"/></a>
</p>
